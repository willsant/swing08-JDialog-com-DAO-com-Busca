...
public class FramePrincipal extends JFrame
{
	...
	private JMenuItem menuItemRequisicao;
	...
	public FramePrincipal() 
	{
		...
		menuItemRequisicao = new JMenuItem("Requisicao");
		menuItemRequisicao.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.ALT_MASK));
		menuItemRequisicao.addActionListener(new ActionListener() {
			public void actionPerformed( ActionEvent e) {
				DialogRequisicao dialogRequisicao = new DialogRequisicao(frame);
				dialogRequisicao.novo();
				dialogRequisicao.setVisible(true);
			}
		});
		mnCadastrar.add(menuItemRequisicao);
